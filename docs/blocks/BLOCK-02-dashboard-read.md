...
> **Trạng thái:** PLANNED · **Phụ thuộc:** B1 (.env contract) + PoC Infuse deep link PASS
...
## 5–7. Implementation / QA / Release
Checklist chi tiết viết khi block chuyển IN PROGRESS. **DoD khung:** grid ≥100 phim mượt trên iPhone · deep link Infuse mở phát được file thật · Lighthouse mobile ≥85 · kill Radarr → BR-1 đúng.
