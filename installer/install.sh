...
main() {
  ...
  mkdir -p "$tmp_dir/definitions" "$tmp_dir/lib" "$tmp_dir/templates"
  ...
  download "$VIETARR_RELEASE_BASE/lib/install-definitions.sh" "$tmp_dir/lib/install-definitions.sh"
  download "$VIETARR_RELEASE_BASE/lib/wiring.mjs" "$tmp_dir/lib/wiring.mjs"
  download "$VIETARR_RELEASE_BASE/definitions/README.md" "$tmp_dir/definitions/README.md"
